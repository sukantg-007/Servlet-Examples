		...
		<c:forEach var="product" items="products">
			<div class="col-md-3 text-center">
				...
				<button class="btn btn-danger my-cart-btn"
					...
					data-price="${product.getPrice()}" data-quantity="1" data-catagory="${product.getCatagory()}"
					data-isavailable="${product.getIsAvailable()}"
					data-pimg_path="images/${product.getPimg_path()}">Add to Cart</button>
