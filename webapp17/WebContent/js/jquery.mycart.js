...
(function ($) {
  ...
  var ProductManager = (function () {
    ...
    */
    ...
    var addProduct = function (id, name, summary, price, quantity,catagory, isavailable, image) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    */
    ...
    $(document).on('click', targetSelector, function () {
      ...
      var catagory = $target.data('catagory');
      var isAvailable = $target.data('isAvailable');
