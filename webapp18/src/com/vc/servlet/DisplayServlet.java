...
public class DisplayServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//obtaining all attributes of session obj
		...
		out.println("</thead><tbody>");		
			out.println("<tr>");
			out.println("<td>"+(String)session.getAttribute("eid")+"</td>");
			out.println("<td>"+(String)session.getAttribute("ename")+"</td>");
			out.println("<td>"+(String)session.getAttribute("esal")+"</td>");
			out.println("<td>"+(String)session.getAttribute("eaddr")+"</td>");
